                    ...
                    try:
                        ...
                        if model_input is not None and not model_input.empty:
                            ...
                            if self.strategy and prediction is not None:
                                self.logger.info(f"Model prediction received - signals will be generated by trading service")
                                # The actual signal generation happens in LiveTradingService._trading_loop
                                # which calls strategy.generate_signals(market_data, portfolio)
                        else:
