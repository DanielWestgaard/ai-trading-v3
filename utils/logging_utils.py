...
def setup_logging(
    name='logging',
    type='logging_utils',
    log_level=sys_config.DEFAULT_LOG_LEVEL,
    log_format=sys_config.DEFAULT_LOG_FORMAT,
    date_format=sys_config.DEFAULT_DATE_FORMAT,
    log_to_console=True,
    log_to_file=True,
    log_dir=sys_config.BASE_LOGS_DIR,
    max_file_size=10*1024*1024,  # 10 MB - remove?
    backup_count=5,
    include_trade_logs=False,
    include_performance_logs=False,
    environment=sys_config.DEV_ENV
):
    """
